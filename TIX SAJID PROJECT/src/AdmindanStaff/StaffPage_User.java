...
public class StaffPage_User extends javax.swing.JFrame {
    ...
    private void ShowComboDB(){
        ...
        data.addElement("-- Pilih Nama Bioskop --");
    ...
    private void initComponents() {
        ...
        input_nama_bioskop.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ALAM SUTERA XXI", "BSD XXI", "BINTARO XCHANGE XXI", "SUMMARECON MALL SERPONG XXI", "THE BREEZE XXI", " " }));
        input_nama_bioskop.setSelectedIndex(-1);
    ...
    private void tabelUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelUserMouseClicked
        ...
        jComboBox1.setSelectedItem(tableUser.getValueAt(tabelUser.getSelectedRow(), 5));
